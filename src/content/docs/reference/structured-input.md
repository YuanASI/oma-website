...
description: "Pass a complete LLMMessage array instead of a string to run(), stream(), and runAgent(): prior turns, image blocks, and validated deep copies."
---
...
[streaming](https://github.com/open-multi-agent/open-multi-agent/blob/v1.20.0/docs/streaming.md), this validation happens when `stream()` is called,
