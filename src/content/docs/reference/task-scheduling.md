---
title: Task Scheduling and Dispatch
description: "Run event-driven task DAGs with assignment strategies, capability requirements, structured handoffs, per-task approvals, and task-scoped results."
---
