...
[`commission-reconciliation-recovery.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.20.0/packages/core/examples/cookbook/commission-reconciliation-recovery.ts)
