...
description: "Revise the not-yet-executed part of a task graph after an outcome with validated, approvable, append-only plan patches."
---
...
[`commission-reconciliation-recovery.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.18.0/packages/core/examples/cookbook/commission-reconciliation-recovery.ts)
