...
description: "Persist long-running task workflows and resume after a crash, abort, or restart — opt-in, task-grained, and stored over the MemoryStore you already use."
---
