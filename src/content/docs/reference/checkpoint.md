...
description: "Opt-in per-run snapshot and resume over any MemoryStore — snapshot after each completed task, then restore() to skip finished work and continue after a crash, abort, or restart."
---
