---
title: "Consensus"
description: "runConsensus proposer-to-judge verification, the per-task verify hook, and the shared token-budget invariant."
---
