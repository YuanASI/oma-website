---
title: "Egress policy"
description: "Restrict which origins the built-in LLM adapters may reach — allowlist or offline mode, intersected across orchestrator, run, and agent scope."
---
...
| MCP stdio child | Not covered. OMA starts the configured child and exchanges stdio messages; it cannot constrain connections opened inside the MCP server. See [MCP tools](https://github.com/open-multi-agent/open-multi-agent/blob/v1.20.0/docs/mcp.md#egress-and-process-boundaries). |
