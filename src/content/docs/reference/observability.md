...
[`observability-release-readiness.md`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.18.0/docs/observability-release-readiness.md).
...
[`observability-v2/otlp-backend.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.18.0/packages/core/examples/integrations/observability-v2/otlp-backend.ts)
...
account anywhere. See [`packages/otel/README.md`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.18.0/packages/otel/README.md)
...
Forward trace spans to OpenTelemetry, Datadog, Honeycomb, Langfuse, or your own run database only after deciding what data is safe for that sink. See [`integrations/trace-observability`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.18.0/packages/core/examples/integrations/trace-observability.ts) for a runnable example.
...
closes the store. See [docs/cli.md](/reference/cli/) for overwrite, stdout, stderr, and
exit-code behavior.
