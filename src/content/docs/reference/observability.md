---
title: "Observability"
description: "Three telemetry layers: onProgress events, onTrace spans, and the static post-run dashboard."
---
...
The library does not write files by itself. The CLI can write dashboard HTML for you with `oma run --dashboard`; see [docs/cli.md](/reference/cli/).
