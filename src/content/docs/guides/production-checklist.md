...
The deep dives live in the reference: [Context management](/reference/context-management/) for the strategies and tool-result compression, [Tool configuration](/reference/tool-configuration/) for grants and the filesystem sandbox, and [Checkpoint & resume](/reference/checkpoint/) for durable snapshot/restore.
