...
description: "The controls to wire up before going live — token budget, timeouts, retries, checkpoint/resume, tool-output limits, loop detection, tracing, and tool grants."
---
...
The deep dives live in the reference: [Context management](/reference/context-management/) for the strategies and tool-result compression, [Tool configuration](/reference/tool-configuration/) for grants and the filesystem sandbox, and [Checkpoint & resume](/reference/checkpoint/) for surviving a crash or restart.
