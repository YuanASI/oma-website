...
可运行版本：[`batching-exporter.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.13.0/packages/core/examples/integrations/observability-v2/batching-exporter.ts)。
...
可运行版本：[`in-memory-store.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.13.0/packages/core/examples/integrations/observability-v2/in-memory-store.ts)
和 [`file-trace-store.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.13.0/packages/core/examples/integrations/observability-v2/file-trace-store.ts)。
...
可运行的内存 provider 版本：[`otel-provider.ts`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.13.0/packages/core/examples/integrations/observability-v2/otel-provider.ts)。
...
和 [`FaaS`](https://github.com/open-multi-agent/open-multi-agent/blob/v1.13.0/packages/core/examples/integrations/observability-v2/serverless-lifecycle.ts)
示例。
