...
export const zh: UiDict = {
  ...
  enterpriseDialog: {
    ...
    body: '联系框架作者本人，沟通你的业务场景、技术方案与生产落地目标。',
    servicesLabel: '可提供的工程服务',
    services: [
      { code: 'S-01', title: 'AI Agent 定制开发', body: '业务场景梳理、Agent 设计、Prompt 与评估、生产部署、私有化及持续支持。' },
      { code: 'S-02', title: '多智能体系统集成', body: '多 Agent 架构与编排、RAG、CRM / ERP / 内部 API 对接、性能与稳定性调优。' },
      { code: 'S-03', title: '企业 AI 咨询', body: 'AI 场景评估、技术选型、POC、ROI 估算与落地路线规划。' },
    ],
    contactEyebrow: '本人微信',
    contactTitle: '扫码添加 open-multi-agent 作者 JackChen 本人',
