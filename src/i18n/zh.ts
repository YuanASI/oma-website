...
export const zh: UiDict = {
  ...
  capabilitiesPage: {
    ...
    flow: [
      ...
      { n: '04', tag: '治理', title: '策略为派发设闸', body: '在正确的边界分别审批计划、每个就绪任务与高影响工具调用。' },
    ...
    groups: [
      ...
      },
      {
        tag: '控制 · 治理',
        title: '把策略放在正确的边界。',
        body: '声明必需或偏好的角色、有序审阅路径与预算感知降级。分别为计划、就绪任务和高影响工具设闸，再显式检查 governanceConclusion，而不是靠推断判断合规。',
      ...
      },
      {
        tag: '检查 · 评估',
        title: '把一次运行变成可复查证据。',
        body: '稳定运行标识、execution receipt、TraceStore、离线 Run Viewer 与可选 OpenTelemetry 让运行可检查；EvalSet、Scorer、报告与 Gate 再把证据变成回归检查。',
      ...
      },
      {
        tag: '模型 · 工具',
        title: '带上你已经使用的环境。',
        body: '在同一团队混用云端与本地模型，把 MCP 服务器作为按需工具接入，并通过 ACP 或进程后端运行外部编码智能体。Core 始终是可嵌入的库，而不是托管服务。',
  ...
  blog: {
    seo: {
      ...
      description:
        '面向 TypeScript 团队的可运行多智能体应用方案、真实工作流观察，以及有证据的框架选型指南。',
    },
    eyebrow: '博客',
    title: '让多智能体系统进入真实工作。',
    lede: '可运行的应用方案、来自工作流设计的一线观察，以及面向 TypeScript 团队的有证据选型指南。',
    sections: {
      application: {
        index: '01',
        eyebrow: '应用方案',
        title: '先讲工作，再讲框架。',
        lede: '把输入、交接、交付物和边界讲清楚；每篇方案背后都有可运行示例。',
      },
      fieldNote: {
        index: '02',
        eyebrow: '一线观察',
        title: '工作流证据反复告诉我们的事。',
        lede: '明确观察范围：原型就是原型，公开项目保持可追溯，不知道的部分继续留白。',
      },
      decisionGuide: {
        index: '03',
        eyebrow: '选型评测',
        title: '按工作流选，不按声量选。',
        lede: '用一手来源解释每种方案适合谁，也明确写出 open-multi-agent 不适合什么。',
      },
      archive: {
        index: '04',
        eyebrow: '工程与发布',
        title: '技术文章归档。',
        lede: '收录机制解析、集成、生态观察与产品更新。',
      },
    },
    contentTypes: {
      application: '应用方案',
    ...
    related: {
      eyebrow: '继续深入',
      title: '从场景走到实现。',
      lede: '先判断产品是否适合，再运行对应工作流，最后接入你已经在用的技术栈。',
      solutions: '解决方案',
      examples: '可运行示例',
      integrations: '集成',
      comparisons: '框架对比',
